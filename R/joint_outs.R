...
#' method that takes \eqn{\Lambda^*_i = 3} and the binary method (used for binary target discrete variables,
#' upon removal of marginal outliers) which uses \eqn{\Lambda^*_i = 2}.
#'
#'
...
#' @param method Method used for detecting an optimal \eqn{\Lambda^*_i} value (see documentation of kde_classif & consec_angles functions); only "consec_angles", "conservative" and "bin" are supported,
...
#' threshold \eqn{\Lambda_i}. Set this to the maximum value of 39 if you don't want such a restriction (see documentation of consec_angles function).
#' Argument is ignored if method is not "consec_angles".
#'
